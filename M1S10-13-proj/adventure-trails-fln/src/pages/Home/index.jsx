...
<div className={style.container} >
   ...
   <div className={style.content}>
    <h2>Que tal aproveitar um tempo
        com a natureza?
    </h2>
    ...
    <Button variant="contained" color="secondary"><Link to="lista-trilha">Explorar trilhas</Link></Button>
    </ThemeProvider>
   </div>
   ...
   <div className={style.description}>
    ...
    <ThemeProvider theme={theme}>
    <Button variant="contained" color="primary"><Link to="lista-trilha">Explorar trilhas</Link></Button>
    </ThemeProvider>
   </div>
    ...
    <div className="side">
      ...
      <ThemeProvider theme={theme}>
      <Button variant="contained" color="secondary"><Link to="cadastro-trilha">Cadastrar Trilhas</Link></Button>
      </ThemeProvider>
  

    </div>
    <img src="https://i.ibb.co/D4b0LV6/trail-side-img.png" alt="Imagem de Trilha" />
   </div>
