...
<div className={style.container} >
   ...
   <div className={style.content}>
    ...
    <Button variant="contained" color="secondary">Explorar trilhas</Button>
    </ThemeProvider>
   </div>
   ...
   <div className={style.description}>
    ...
    <ThemeProvider theme={theme}>
    <Button variant="contained" color="primary">Explorar trilhas</Button>
    </ThemeProvider>
   </div>
    ...
    <div className="side">
      ...
      <ThemeProvider theme={theme}>
      <Button variant="contained" color="secondary">Cadastrar nova trilha</Button>
      </ThemeProvider>
    </div>
